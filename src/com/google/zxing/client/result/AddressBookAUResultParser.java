...
public final class AddressBookAUResultParser extends ResultParser {
  ...
  public AddressBookParsedResult parse(Result result) {
    ...
    String category = matchSinglePrefixedField("CATEGORIES:", rawText, '\r', false);
    String tag = matchSinglePrefixedField("TAG:", rawText, '\r', false);
    
    return new AddressBookParsedResult(maybeWrap(name), pronunciation, phoneNumbers, emails, note,
        addresses, null, null, null, null,null,null, category, tag);
  }
